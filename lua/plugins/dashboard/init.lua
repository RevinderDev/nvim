...
return {
  ...
  config = function()
    ...
    -- dashboard.section.header.val = require('plugins.dashboard.banners').dashboard()
    -- local date = os.date '%d %b %y'
    ...
    --   dashboard.button('<Leader>sf', '   [S]earch [f]ile', ':Telescope find_files<CR>'),
    --   dashboard.button('<Leader>s.', '   [S]earch recent', ':Telescope oldfiles<CR>'),
    --   dashboard.button('<Leader>sk', '   [S]earch [K]eymaps', ':Telescope keymaps<CR>'),
    --   dashboard.button('p', '   [P]lugins', ':Lazy<CR>'),
    --   dashboard.button('<C-S-q>', '   Quit NVIM', ':qa<CR>'),
    -- }
    --
